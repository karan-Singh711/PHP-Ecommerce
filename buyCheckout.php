  ...
  <div class="w-full max-w-4xl bg-white shadow-md rounded-2xl p-8 flex flex-col md:flex-row gap-8">
    ...
    <div class="w-full md:w-1/2">
      ...
      <form class="space-y-5">
        <div>
          <label class="block text-[#555879] text-sm mb-2">Full Name</label>
          <input type="text" placeholder="John Doe" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#98A1BC]" />
        </div>

        <div>
          <label class="block text-[#555879] text-sm mb-2">Phone Number</label>
          <input type="tel" placeholder="+91 9876543210" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#98A1BC]" />
        </div>

        <div>
          <label class="block text-[#555879] text-sm mb-2">Email</label>
          <input type="text" placeholder="Invalid@gmail.com" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#98A1BC]" />
        </div>

        <div>
          <label class="block text-[#555879] text-sm mb-2">Address</label>
          <textarea placeholder="123, Street Name, City, State" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#98A1BC]" rows="3"></textarea>
        </div>
